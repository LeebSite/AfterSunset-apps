...
<div class="container mt-5">
    <h1 class="mb-4 text-4xl font-extrabold dark:text-white">Log Aktivitas</h1>
        ...
        <table class="min-w-full divide-y divide-gray-200 bg-white text-sm">
            <thead>
                <tr>
                    ...
                    <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Deskripsi Aktivitas</th>
                    <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Waktu tanggal</th>
                </tr>
            </thead>
